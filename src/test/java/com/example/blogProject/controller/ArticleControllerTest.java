...
class BlogApiControllerTest {
    ...
    public void addArticle() throws Exception {
        ...
        final AddArticleDto userRequest = new AddArticleDto(title, content);
    ...
    public void findAllArticles() throws Exception {
        ...
        List<Article> articles = blogRepository.findAll();
        assertThat(articles.size()).isEqualTo(1);
        assertThat(articles.get(0).getTitle()).isEqualTo(savedArticle.getTitle());
        assertThat(articles.get(0).getContent()).isEqualTo(savedArticle.getContent());
    }
    ...
    public void updateArticle() throws Exception {
        ...
        UpdateArticleDto request = new UpdateArticleDto(newTitle, newContent);
